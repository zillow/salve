...
def test_render_binned_cycle_errors() -> None:
    ...
    #cycle_consistency.render_binned_cycle_errors(num_outliers_per_cycle, cycle_errors)
...
def test_compute_translation_cycle_error() -> None:
    ...
    cycle_nodes = (0, 1, 2)
    cycle_error = cycle_consistency.compute_translation_cycle_error(wRi_list, i2Si1_dict, cycle_nodes=cycle_nodes, verbose=True)

...
def test_rotmat2d() -> None:
    """Ensures that valid rotation matrices are generated by the rotmat2d() function.

    We define `valid` as membership in SO(2), thus we check det(R) and R^T R = I.
    """
    for _ in range(1000):
        ...
        determinant = np.linalg.det(computed)

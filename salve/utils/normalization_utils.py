"""Utilities for normalizing image data to ImageNet statistics.

Adapted from `mseg-semantic` (MIT License):
https://github.com/mseg-dataset/mseg-semantic/blob/master/mseg_semantic/utils/normalization_utils.py
"""

...
def export_horizonnet_zind_predictions(
    ...
    oldbuildingid_to_newbuilding_id_map = { row["old_home_id"].zfill(4): row["new_home_id"].zfill(4) for row in tsv_rows}
    
    # Note: pano_guid is unique across the entire dataset.
    panoguid_to_panoid = {}
    panoguid_to_buildingid = {}
    ...
    for pano_metadata in pano_mapping_rows:
        ...
        old_building_id = dgx_fpath.split("/")[-3].zfill(4)
        try:
            new_building_id = oldbuildingid_to_newbuilding_id_map[old_building_id]
        except:
            continue
        panoguid_to_buildingid[pano_guid] = new_building_id
    ...
    for row in tsv_rows:
        ...
        #     for j in range(1):
            ...
            pano_guid = Path(json_fpath).stem
            #import pdb; pdb.set_trace()

            if pano_guid not in panoguid_to_panoid:
                print(f"Missing the panorama GUID mapping for Building {zind_building_id} -> {pano_guid}")
                continue
            i = panoguid_to_panoid[pano_guid]
            zind_building_id = panoguid_to_buildingid[pano_guid]
            ...
            if render_on_pano:
                ...
                plt.tight_layout()
                os.makedirs(f"prod_pred_model_visualizations_2022_08_12_bridge_train/{model_name}_bev", exist_ok=True)
                plt.savefig(
                    f"prod_pred_model_visualizations_2022_08_12_bridge_train/{model_name}_bev/{zind_building_id}_{i}.jpg",
                    dpi=400,
                )
                # plt.show()
                plt.close("all")
...
if __name__ == "__main__":
    ...
    # New as of 2022/08/02
    #predictions_data_root = "/Users/johnlambert/Downloads/zind_horizon_net_predictions_2022_08_02/inference"
    #predictions_data_root = "/Users/johnlambert/Downloads/zind_horizon_net_predictions_2022_08_04_/inference_reproc"

    #predictions_data_root = "/Users/johnlambert/Downloads/zind_horizon_net_predictions_2022_08_04_/inference_0801_reproc_trainset"

    predictions_data_root = "/Users/johnlambert/Downloads/2022_08_07_training/predictions_0801"
    ...
    export_dir = "/Users/johnlambert/Downloads/zind_horizon_net_predictions_2022_08_12"

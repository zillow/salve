...
def load_opensfm_reconstruction_from_json(obj: Dict[str, Any]):
    ...
    reconstruction = OpenSfmReconstruction(
        camera,
        pose_dict,
        points,
        rgb
...
def load_opensfm_reconstructions_from_json(reconstruction_json_fpath: str) -> List[OpenSfmReconstruction]: # : # -> types.Reconstruction:
    """

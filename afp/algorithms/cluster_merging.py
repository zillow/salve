...
def find_unused_WDOs(
    cut_crossings, gt_floor_pose_graph, per_edge_wdo_dict: Dict[Tuple[int, int], EdgeWDOPair], i2Si1_dict_consistent
):
    """
    ...
    for (i1, i2) in i2Si1_dict_consistent:
        ...
        alignment_object = (per_edge_wdo_dict[(i1, i2)].alignment_object,)
        i1_wdo_idx = (per_edge_wdo_dict[(i1, i2)].i1_wdo_idx,)
        i2_wdo_idx = per_edge_wdo_dict[(i1, i2)].i2_wdo_idx
